...
const BoxItem = ({ img, description, title }: Props) => {
  return (
    <div className="mb-3 flex max-w-[37rem] items-center gap-6 rounded-lg border border-slate-900 bg-transparent from-mint to-transparent px-4 py-6 transition-all duration-700 hover:bg-gradient-to-r">
