...
const Numbers = () => {
  return (
    <>
      <div className="container mx-auto flex items-center justify-center px-4 mobile:flex-col mobile:space-x-0 mobile:space-y-6 mobile:pt-16 md:flex-row  md:space-y-0 md:space-x-8 md:pt-32 lg:space-x-12">
